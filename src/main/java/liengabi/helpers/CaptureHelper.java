...
public class CaptureHelper extends ScreenRecorder {
    ...
    public static void takeScreenshot(String screenshotName) {
        ...
        if (!theDir.exists()) { //ktra thư muc screenshot kia có tồn tại hay k
            theDir.mkdirs(); // k có thì tạo mới thư mục
        }
        ...
        try {
            ...
            System.out.println("Error. Can not Take screenshot " + screenshotName + " successfully");
